...
<head>
    ...
    <link rel="stylesheet" href="/resource/style-akun.css">
    <link rel="stylesheet" href="/resource/style-ubahsandi.css">
</head>
        ...
        <div class="sidebar">
            <div class="AkunSaya">
                ...
                <div class="attribute-content">
                    <a href="<?= base_url('penjual/akun') ?>">Profil</a>
                    <!-- <a href="Alamat.html">Alamat</a> -->
                    <a href="<?= base_url('penjual/ubah_sandi') ?>">Ubah Kata sandi</a>
